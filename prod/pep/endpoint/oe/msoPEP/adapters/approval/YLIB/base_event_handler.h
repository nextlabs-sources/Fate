...
public:
    ...
    virtual HRESULT OnInvoke(DISPID dispidMember, REFIID riid, LCID lcid, WORD wFlags, DISPPARAMS* pdispparams, VARIANT* pvarResult, EXCEPINFO* pexcepinfo, UINT* puArgErr){return	E_NOTIMPL;};
...
public:
    ...
    BOOL RegisterEventDispatch(CComPtr<IUnknown> spUnkCP)
    {
        HRESULT hr = S_OK;
