...
#ifndef __NX_CONTAINER_STREAM_HPP__
#define __NX_CONTAINER_STREAM_HPP__
...
namespace details {
    ...
    protected:
        ...
        {
            return (unsigned __int64)m_data.size();
        }
...
typedef container_stream<std::wstring>              wstringstream;
