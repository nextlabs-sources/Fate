...
static void GetTimeString(UInt64 timeValue, TCHAR *s, size_t size)
{
  _snwprintf_s(s, size, _TRUNCATE, TEXT("%02d:%02d:%02d"), 
...
bool CProgressDialog::OnTimer(WPARAM /* timerID */, LPARAM /* callback */)
{
  ...
  if (elapsedChanged)
  {
    ...
    else
    {
      ...
      {
        TCHAR s[40];
        GetTimeString(remainingSec, s, 40);
