...
PGPOptionListRef	PGPOUIDisplayInvalidKeys( PGPContextRef context,
							PGPBoolean displayInvalidKeys );
...
PGPOptionListRef	PGPOUISavePassphrase( PGPContextRef context,
							PGPBoolean* shouldSave );
 
typedef PGPError (*PGPVerifyPassphraseHandlerProcPtr)(PGPContextRef context, const char* passphrase, PGPUserValue userValue);

PGPOptionListRef	PGPOVerifyPassphraseHandler( PGPContextRef context,
							PGPVerifyPassphraseHandlerProcPtr handler,
								PGPUserValue handlerData);
