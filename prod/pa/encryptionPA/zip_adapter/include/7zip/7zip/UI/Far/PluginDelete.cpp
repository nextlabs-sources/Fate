    ...
    int opMode)
{
  ...
  */
  if ((opMode & OPM_SILENT) == 0)
  {
    ...
    if (numItems == 1)
    {
      _snprintf_s(msg, 1024, _TRUNCATE, g_StartupInfo.GetMsgString(NMessageID::kDeleteFile),
          panelItems[0].FindData.cFileName);
      msgItems[1] = msg;
    }
    else if (numItems > 1)
    {
      _snprintf_s(msg, 1024, _TRUNCATE, g_StartupInfo.GetMsgString(NMessageID::kDeleteNumberOfFiles), 
          numItems);
      msgItems[1] = msg;
    }
