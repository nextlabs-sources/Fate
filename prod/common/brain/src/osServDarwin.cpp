...
// Author : Dominic Lam
// Date   : 5/23/2006
// Note   : First attempt to map the OS services for Darwin 
...
BJ_waitResult_t bjSemaphore::take (timespec t)
{
  ...
  /*This is the legacy code for LFSE. In the new code with SDK, this
  code is not useful any more. In order to make the code pass the compilation
  , this code has been commented out because sem_timedwait is not supported
  on Darwin.
