...
#define HDR_DLG_INFO    L"The following hidden information is found. Click Remove All under each type to remove the hidden information from the attachment."
#define HDR_DLG_WARN    L"NOTE: Some changes cannot be undone!"
