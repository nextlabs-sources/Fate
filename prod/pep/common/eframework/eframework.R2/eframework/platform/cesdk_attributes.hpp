...
namespace nextlabs
{
  ...
  class cesdk_attributes
  {
     ...
     *  \sa destroy
     */
    _Check_return_ static CEAttributes* create(void)
    {
     ...
     *  \sa create, destroy
     */
    _Check_return_ static bool add( const nextlabs::cesdk_loader& cesdk ,
				   _In_ CEAttributes* in_attrs ,
     ...
     *  \sa create
     */
    static void destroy( const nextlabs::cesdk_loader& cesdk ,
			 _In_ CEAttributes* in_attrs )
    {
