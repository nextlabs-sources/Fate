...
namespace nextlabs
{
  ...
  class recursion_control : boost::noncopyable
  {
     ...
     *         to call auto_SetThreadEnable for a thread that has not called
     *         thread_disable.
     *  \sa thread_disable
     */
    ...
    /** thread_disable
     *
     *  \brief Set hooking state for the current thread.
     *  \sa thread_enable
     */
    ...
    /** process_enable
     *
     *  \brief Enable hooking for the current process.
     *  \sa process_disable
     */
    ...
    /** is_disabled
     *
     *  \brief Determine the hook state for the current process or thread.
   ...
   *
   *  \brief Handle thread disablement automatically.
   */
