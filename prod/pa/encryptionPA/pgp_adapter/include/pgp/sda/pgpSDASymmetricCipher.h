...
PGPError 	PGPsdaNewSymmetricCipherContext( PGPContextRef context,
...
PGPError 	PGPsdaFreeSymmetricCipherContext( PGPSymmetricCipherContextRef ref );

/*____________________________________________________________________________
	Make an exact copy of the cipher, including the key.
____________________________________________________________________________*/

PGPError 	PGPsdaCopySymmetricCipherContext( PGPSymmetricCipherContextRef ref,
					PGPSymmetricCipherContextRef *outRef );
...
PGPError 	PGPsdaInitSymmetricCipher( PGPSymmetricCipherContextRef ref,
					const void *key );
...
PGPError 	PGPsdaWipeSymmetricCipher( PGPSymmetricCipherContextRef ref );

/*____________________________________________________________________________
	"Wash" the symmetric cipher
____________________________________________________________________________*/

PGPError 	PGPsdaWashSymmetricCipher( PGPSymmetricCipherContextRef ref,
...
PGPError 	PGPsdaSymmetricCipherEncrypt( PGPSymmetricCipherContextRef ref,
					const void *in, void *out );
					
PGPError 	PGPsdaSymmetricCipherDecrypt( PGPSymmetricCipherContextRef ref,
					const void *in, void *out );
...
____________________________________________________________________________*/
PGPError 	PGPsdaGetSymmetricCipherSizes( PGPSymmetricCipherContextRef ref,
...
____________________________________________________________________________*/
PGPError	PGPsdaSymmetricCipherRollback( PGPSymmetricCipherContextRef ref, 
					PGPSize size );
