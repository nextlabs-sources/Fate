...
PGPError PGPSetContextTempDirectoryU8( PGPContextRef context, const PGPChar8 *path );
PGPError PGPSetContextTempDirectoryU16( PGPContextRef context, const PGPChar16 *path );

PGPError PGPGetContextTempDirectoryU8( PGPContextRef context, PGPChar8 **path );
PGPError PGPGetContextTempDirectoryU16( PGPContextRef context, PGPChar16 **path );
...
PGPError PGPGetProxyHostU8(PGPContextRef context, PGPProxyServerType type, const PGPChar8 *destHost, PGPUInt16 destPort, PGPChar8 **proxyAddress, PGPUInt16 *proxyPort, PGPChar8 **proxyUserName, PGPChar8 **proxyPassword );
PGPError PGPGetProxyHostU16(PGPContextRef context, PGPProxyServerType type, const PGPChar16 *destHost, PGPUInt16 destPort, PGPChar16 **proxyAddress, PGPUInt16 *proxyPort, PGPChar16 **proxyUserName, PGPChar16 **proxyPassword );

PGPError PGPMakeProxyAuthStringU8(PGPContextRef context, const PGPByte *responseHeader, const PGPChar8 *proxyUserName, const PGPChar8 *proxyPassword, const PGPChar8 *resource_buf, PGPByte *bufferSend, PGPSize bufferSize);
PGPError PGPMakeProxyAuthStringU16(PGPContextRef context, const PGPByte *responseHeader, const PGPChar16 *proxyUserName, const PGPChar16 *proxyPassword, const PGPChar16 *resource_buf, PGPByte *bufferSend, PGPSize bufferSize);

PGPError PGPRetrieveOCSPStatusU8(PGPSocketRef Socket, const PGPChar8 *httpUrl, const PGPChar8 *proxyHost, const PGPChar8 *proxyUserName, const PGPChar8 *proxyPassword, PGPKeyDBObjRef requestCertificate, PGPKeyDBObjRef issuerCertificate, PGPKeyDBObjRef signerKey, PGPOCSPStatus *status, PGPOptionListRef firstOption, ...);
PGPError PGPRetrieveOCSPStatusU16(PGPSocketRef Socket, const PGPChar16 *httpUrl, const PGPChar16 *proxyHost, const PGPChar16 *proxyUserName, const PGPChar16 *proxyPassword, PGPKeyDBObjRef requestCertificate, PGPKeyDBObjRef issuerCertificate, PGPKeyDBObjRef signerKey, PGPOCSPStatus *status, PGPOptionListRef firstOption, ...);

PGPError PGPskepSendSharesU8(PGPskepRef skep, PGPKeyDBObjRef authKey, const PGPChar8 *passphrase, PGPShareRef shares, const PGPChar8 *destSocketAddress );
PGPError PGPskepSendSharesU16(PGPskepRef skep, PGPKeyDBObjRef authKey, const PGPChar16 *passphrase, PGPShareRef shares, const PGPChar16 *destSocketAddress );

PGPError PGPskepReceiveSharesU8(PGPskepRef skep, PGPKeyDBObjRef authKey, const PGPChar8 *passphrase );
PGPError PGPskepReceiveSharesU16(PGPskepRef skep, PGPKeyDBObjRef authKey, const PGPChar16 *passphrase );

PGPError PGPMakeReconstructionU8(PGPReconContextRef reconRef, PGPReconPrompts inPromptInfo, PGPReconPasses inPassInfo, PGPUTF8 *inPassphrase );
PGPError PGPMakeReconstructionU16(PGPReconContextRef reconRef, PGPReconPrompts inPromptInfo, PGPReconPasses inPassInfo, PGPChar16 *inPassphrase );
