...
namespace nextlabs
{
  ...
  class Obligation
  {
    public:
       ...
       */
      bool GetObligationValue( _In_  const wchar_t* ob_key ,
	...
	return false;
       ...
       */
      bool IsObligationSet( _In_ const wchar_t* ob_key ) const
      {
	assert( ob_key != NULL );
	if( ob_key == NULL )
	{
  ...
  class Obligations
  {
    public:
       ...
       */
      static bool GetValue( _In_ const WCHAR* (*pfn_CEM_GetString)(CEString) ,
	...
	return false;
       ...
       */
      void Assign( _In_ const WCHAR* (*pfn_CEM_GetString)(CEString) ,
		   CEAttributes& obligations )
      {
	assert( pfn_CEM_GetString != NULL );
	...
	return obs.end();
       ...
       */
      bool IsObligationSet( _In_ const wchar_t* ob_name ) const
      {
	assert( ob_name != NULL );
	if( ob_name == NULL )
	{
