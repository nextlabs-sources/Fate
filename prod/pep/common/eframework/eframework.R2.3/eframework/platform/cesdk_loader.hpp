...
namespace nextlabs
{
  ...
  static const wchar_t* CESERVICE   = L"ceservice.dll";
  ...
  class cesdk_loader
  {
	...
	libmap[sdk_libs[i].libname] = hlib;
      ...
      fns.ServiceInvoke              = (ServiceInvoke_t)GetProcAddress(libmap[CESERVICE],
								       "ServiceInvoke");
      fns.ServiceResponseFree        = (ServiceResponseFree_t)GetProcAddress(libmap[CESERVICE],
									     "ServiceResponseFree");
