...
#define POLICY_CONTROLLER_HEADER 
 	...
 	*/
	export prototype INT DiscoverIcenetServers(HWND);
                                                        
    /*
     * Create and configure the logging.properties file
     */
	export prototype INT CreateLoggingPropertiesFile(HWND, STRING);  

	
	/*
	 * Create a configure the comm profile
	 */
	export prototype INT CreateCommProfile(HWND, STRING, STRING); 
	
	   
	/*
	 * Create a online help
	 */
	export prototype INT CreateOnlineHelp(HWND, STRING, STRING); 
	
	/*
	 * Perform post install work - Creating comm profile and logging.properties
	 */                                  
	 export prototype INT PostInstall(HWND);  
	 ...
	 */                                  
	  ...
	  */                                         
	  ...
	  /* 
	   * Remove all the files from INSTALLDIR before starting the installation
	   */
	  export prototype INT RemoveRegsitrationFiles(HWND);
#endif
