...
namespace nextlabs
{
  ...
  class policy_obligation
  {
    public:
       ...
       */
      bool get_obligation_value( _In_  const wchar_t* ob_key ,
				 std::wstring& ob_value ) const
      {
	assert( ob_key != NULL );
	if( ob_key == NULL )
	{
	...
	return false;
       ...
       */
      bool is_obligation_set( _In_ const wchar_t* ob_key ) const
      {
	assert( ob_key != NULL );
	if( ob_key == NULL )
	{
	...
	return false;
      ...
      const wchar_t* get_name(void) const
      {
	return name.c_str();
      }/* get_policy */

      const wchar_t* get_policy(void) const
      {
	return policy.c_str();
      }/* get_policy */

      const nextlabs::policy_obligation_options& get_options(void) const
      {
	return options;
      }/* get_options */
  ...
  class policy_obligations
  {
    public:
       ...
       */
      void assign( const std::list< std::pair<std::wstring,std::wstring> >& obligations )
      {
	...
	return obs.end();
       ...
       */
      bool is_obligation_set( _In_ const wchar_t* in_name ) const
      {
	...
	return false;
       ...
       */
      policy_obligation_list::const_iterator find( const wchar_t* in_name ) const
      {
	assert( in_name != NULL );
	...
	return it;
       ...
       */
      const policy_obligation_list& get_obligations(void)
      {
	return obs;
      }/* get_obligations */
    ...
    private:
       ...
       */
       bool get_value( const std::list< std::pair<std::wstring,std::wstring> >& obligations ,
