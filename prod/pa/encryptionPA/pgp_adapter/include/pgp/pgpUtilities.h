...
enum PGPNotificationReason_
{
	...
	kPGPNotification_KeyRingFileChanged = 2,
...
#undef		PGPSetContextTempDirectory
PGPError	PGPSetContextTempDirectory( PGPContextRef context, const PGPChar8 *path );

#undef		PGPGetContextTempDirectory
PGPError	PGPGetContextTempDirectory( PGPContextRef context, PGPChar8 **path );
...
#define kPGPWipePatternMaxPasses		49
#define kPGPWipePatternDefaultPasses	25
...
PGPError PGPWipePatternGetVector(PGPWipePatternContextRef wipeRef, 
								 PGPUInt32 *vector, 
								 PGPUInt32 *vectorSize);
...
PGPError 	PGPSetTARCacheObjNumericProperty( 
					PGPTARCacheObjRef obj,
					PGPTARCacheObjProperty whichProperty,
					PGPInt32 prop );

PGPError 	PGPSetTARCacheObjTimeProperty( 
					PGPTARCacheObjRef obj,
					PGPTARCacheObjProperty whichProperty,
					PGPTime  prop);
 
 PGPError 	PGPSetTARCacheObjDataProperty( 
					PGPTARCacheObjRef obj,
					PGPTARCacheObjProperty whichProperty,
					void *buffer,
					PGPSize bufferSize);

PGPError	PGPGetTARCacheScanProgress( PGPTARCacheRef ref, 
										PGPUInt32 *numItems, 
										PGPUInt32 *percentDone );
