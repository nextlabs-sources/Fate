...
typedef enum PGPOCSPStatus_
{
	kPGPOCSPResponseStatus_malformedRequest = 1,
	kPGPOCSPResponseStatus_internalError = 2,
	kPGPOCSPResponseStatus_tryLater = 3,	
	kPGPOCSPResponseStatus_sigRequired = 4,	
	kPGPOCSPResponseStatus_unauthorized = 5,	
	kPGPOCSPCertificateStatus_good = 6,
	kPGPOCSPCertificateStatus_revoked = 7,
	kPGPOCSPCertificateStatus_unknown = 8
...
PGPError			PGPGetKeyServerVerificationKeyID(PGPKeyServerRef inKeyServerRef,
						PGPKeyID *	outKeyID);
...
#undef				PGPGetProxyHost
PGPError 			PGPGetProxyHost(
						PGPContextRef context, PGPProxyServerType type,
						const PGPChar8 *destHost, PGPUInt16 destPort,
						PGPChar8 **proxyAddress, PGPUInt16 *proxyPort,
						PGPChar8 **proxyUserName, PGPChar8 **proxyPassword );

#undef				PGPMakeProxyAuthString
PGPError			PGPMakeProxyAuthString(
...
#undef				PGPRetrieveOCSPStatus
PGPError			PGPRetrieveOCSPStatus(
						      PGPSocketRef s,
						      const PGPChar8  *httpUrl,
...
PGPError PGPX509GetCertificationIssuer( PGPKeyDBObjRef certificate,
							   const PGPChar8  *proxyHost,
							   const PGPChar8  *proxyUserName,
							   const PGPChar8  *proxyPassword,
