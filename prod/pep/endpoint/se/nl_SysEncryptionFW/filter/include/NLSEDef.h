...
//
#define NLFSEAcquireContextLockShared(_devext) \
            NLFSEAcquireResourceShared( &(_devext)->StreamCtxLock, TRUE )

#define NLFSEAcquireContextLockExclusive(_devext) \
            NLFSEAcquireResourceExclusive( &(_devext)->StreamCtxLock, TRUE )

#define NLFSEReleaseContextLock(_devext) \
            NLFSEReleaseResource( &(_devext)->StreamCtxLock )
#endif
