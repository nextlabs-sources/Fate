...
#if defined(__GNUC__) && !PGP_OSX
#define PGP_SDK_CDECL __attribute__((__cdecl__))
#elif PGP_WIN32
#define PGP_SDK_CDECL __cdecl
#else
#define PGP_SDK_CDECL	/* assume the code is compiled as cdecl */
#endif

/* Standard event callback declaration */
struct PGPEvent;
typedef PGPError (PGP_SDK_CDECL *PGPEventHandlerProcPtr)(PGPContextRef context,
...
enum PGPAVAttribute_
{
	...
	kPGPAVAttribute_DistributionPoint,
...
/* Preferred email modes, also for use with kPGPKeyProperty_PreferredEmailEncodings */
enum PGPPreferredEmailEncoding_
{
	kPGPPreferredEmailEncoding_Unrecognized	= 1,
	kPGPPreferredEmailEncoding_PGPMIME		= 2,
	kPGPPreferredEmailEncoding_Partitioned	= 3,

	PGP_ENUM_FORCE( PGPPreferredEmailEncoding_ )
} ;
PGPENUM_TYPEDEF( PGPPreferredEmailEncoding_, PGPPreferredEmailEncoding );

/* Signature stripping modes */
enum PGPSignatureCleaning_
{
	kPGPSignatureCleaning_None			= 1,
	kPGPSignatureCleaning_Wrapped		= 2,
	kPGPSignatureCleaning_Replaced		= 3,

	PGP_ENUM_FORCE( PGPSignatureCleaning_ )
} ;
PGPENUM_TYPEDEF( PGPSignatureCleaning_, PGPSignatureCleaning );

/* Passphrase Caching flags */
enum PGPOCachePassphraseFlags_
{
	PGPOCachePassphraseFlags_None			= 0,
	PGPOCachePassphraseFlags_Global			= (1UL << 0 ),
	PGPOCachePassphraseFlags_Persistent		= (1UL << 1 ),
	PGP_ENUM_FORCE( PGPOCachePassphraseFlags_ )
};
PGPENUM_TYPEDEF( PGPOCachePassphraseFlags_, PGPOCachePassphraseFlags );
...
PGPOptionListRef		PGPOObfuscateRecipients(PGPContextRef context,
...
/* Deprecated, use PGPOCacheNamedPassphrase*() */
PGPOptionListRef 		PGPOCachePassphrase( PGPContextRef context,
							PGPUInt32 timeOutSeconds, PGPBoolean globalCache);

PGPOptionListRef 		PGPOCacheNamedPassphrase( PGPContextRef context,
							PGPUInt32 timeOutSeconds, PGPOCachePassphraseFlags flags,  
...
PGPOptionListRef		PGPOExcludeKeySet(PGPContextRef	context,
							PGPKeySetRef	raKeySetRef);

PGPOptionListRef		PGPOStartSerialNumberNumeric(PGPContextRef context,
											  PGPUInt64 snValue);
...
PGPOptionListRef		PGPOPreferredHashAlgorithms(
							PGPContextRef context, 
...
PGPOptionListRef		PGPOCharsetString( PGPContextRef context,
...
PGPOptionListRef		PGPONotationData( PGPContextRef context,
							PGPChar8 const *notationName,
							PGPSize notationNameLength,
							PGPChar8 const *notationValue,
							PGPSize notationValueLength,
							PGPUInt32 flags );

PGPOptionListRef		PGPOPreferredEmailEncoding( PGPContextRef context,
							 PGPPreferredEmailEncoding const * prefEncodings,
							 PGPUInt32 numEncodings);

PGPOptionListRef		PGPOCleanSignatures( PGPContextRef context,
