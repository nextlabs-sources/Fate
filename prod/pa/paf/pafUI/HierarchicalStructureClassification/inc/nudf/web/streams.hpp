...
#ifndef __NX_STREAMS_HPP__
#define __NX_STREAMS_HPP__

#include <nudf\web\astreambuf.hpp>
...
namespace details {
    ...
    struct Value2StringFormatter <uint8_t>
    {
        ...
        static std::basic_string<uint8_t> format(const std::wstring &val)
        {
            return format(NX::utility::conversions::utf16_to_utf8(val));
        }
...
_INT_TRAIT(wchar_t, INT16_MIN, INT16_MAX)
...
private:
    ...
    {
        return pplx::task_from_result(NX::utility::conversions::utf8_to_utf16(*state));
    }
};
