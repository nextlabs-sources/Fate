...
#pragma warning(pop) 
	...
	unsigned int m_nRoundWidth;
	unsigned int m_nRoundHeight;
...
public:
	...
	void SetRound(unsigned int nWidth = 10, unsigned int nHeight = 10){m_nRoundWidth = nWidth; m_nRoundHeight = nHeight;};
