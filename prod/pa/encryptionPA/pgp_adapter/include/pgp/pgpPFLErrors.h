...
enum
{
	...
	*/
	...
	kPGPError_NetLAEmailFailed = -11929,
	kPGPError_LAInvalid = -11928,
	kPGPError_LNVerUnsupported = -11927,
	kPGPError_LNMultipleProdEvals = -11926,
	kPGPError_NetLAProxyAuthRequired = -11925,
	kPGPError_NetLAFailed = -11924,

	kPGPError_CorruptDataBreakFrontend = -11911,	/* internal error, translated to kPGPError_CorruptData */
	kPGPError_UserDisabled			= -11910,
	
	kPGPError_NTDrvIopReadFailed = -11902,
	kPGPError_NTDrvIopWriteFailed = -11901,
	kPGPError_NTDrvIopFileFailed = -11900,
