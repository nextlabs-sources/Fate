...
namespace nextlabs
{
  ...
  class policy_query : boost::noncopyable
  {
     ...
     */
    void set_event_level( int in_event_level ) throw()
    {
     ...
     */
    bool set_source( _In_ const wchar_t* in_resource ,
		     _In_ const wchar_t* in_resource_type ) throw()
    {
     ...
     */
    _Check_return_
    bool add_source_attribute( _In_ const wchar_t* in_key ,
     ...
     */
    bool set_target( _In_ const wchar_t* in_resource ,
		     _In_ const wchar_t* in_resource_type ) throw()
    {
      assert( in_resource != NULL );
      assert( in_resource_type != NULL );
     ...
     */
    _Check_return_
    bool add_target_attribute( _In_ const wchar_t* in_key ,
			       _In_ const wchar_t* in_value )
    {
      assert( in_key != NULL );
      assert( in_value != NULL );
     ...
     */
    _Check_return_
    bool set_action( _In_ const wchar_t* in_action ) throw()
    {
    ...
    void set_application( const wchar_t* in_app_path )
    {
      assert( in_app_path != NULL );
      app_path.assign(in_app_path);
    }/* set_application */

    const nextlabs::policy_obligations& get_obligations(void)
    {
      return obligations;
    }/* get_obligations */
