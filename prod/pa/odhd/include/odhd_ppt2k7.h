#ifndef __H_ODHD_PPT2K7__
#define  __H_ODHD_PPT2K7__
...
static StaticCatTitle gs_CatTitle_Ppt2K7[]={
	{
...
static StaticItemResult gs_ItemTitle_Ppt2K7[]={
...
class CODHDPpt2K7Inspector:public CODHDInspector
{
public:
	CODHDPpt2K7Inspector():CODHDInspector((long)ODHDCAT_PPT_MAX,gs_CatTitle_Ppt2K7)
	{
		m_pApp=NULL;
		GetPPTApp();
		m_HasContentType=FALSE;
		m_InspectorFail1=m_InspectorFail2=m_InspectorFail3=m_InspectorFail4=0;
		m_InspectorIndex1=1;
		m_InspectorIndex2=2;
		m_InspectorIndex3=3;
		m_InspectorIndex4=4;
	};
	virtual ~CODHDPpt2K7Inspector(){};
...
private:
	...
	BOOL			RemoveCategoryOnSlide(PPT::_Presentation*pDoc);
	BOOL			RemoveCategoryOffSlide(PPT::_Presentation*pDoc);
	BOOL			RemoveCategoryCustomXML(PPT::_Presentation*pDoc);
	BOOL			RemoveCategoryNote(PPT::_Presentation*pDoc);
	...
	DWORD				  m_InspectorFail4;

	DWORD	m_InspectorIndex1;//Custom XML
	DWORD	m_InspectorIndex2;//Invisible On-slide content
	DWORD	m_InspectorIndex3;//Off-Slide content
	DWORD	m_InspectorIndex4;//Presentation Notes
