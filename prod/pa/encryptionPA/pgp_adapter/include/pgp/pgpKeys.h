...
enum PGPKeyDBObjProperty_
{
	...
	kPGPKeyProperty_IsX509WrapperKey			= 120,	/* the key was created after the import of X.509 cert */
	kPGPKeyProperty_AuthenticationRequired		= 121,	/* kPGPKeyProperty_NeedsPassphrase and not cached */
	kPGPKeyProperty_IsSubkeyOnToken				= 122,	/* is any of subkeys on token? Only valid for top key. */
	kPGPKeyProperty_IsOnCSP						= 123,
	kPGPKeyProperty_IsPassphraseCachedPersistent = 124,	/* is this key's passphrase in the persistent cache?*/
	kPGPKeyProperty_IsSubkeyOnCSP				= 125, /* is any of subkeys on csp? Only valid for top key. */
	kPGPKeyProperty_IsOnTokenAndKeyring			= 126, /* is the private portion of the key on the token and on the keyring */
	...
	kPGPKeyProperty_RevocationTime				= 305,
	...
	kPGPKeyProperty_PreferredHashAlgorithms = 409,
	kPGPKeyProperty_PreferredEmailEncodings		= 410,
	kPGPKeyProperty_FingerprintV3				= 415,
	...
	kPGPSigProperty_Flags						= 1403,
	kPGPSigProperty_X509Flags					= 1404,
	kPGPSigProperty_HashAlgorithmID				= 1405,
...
enum	/* PGPNotationFlags */
{
	kPGPNotationFlags_UserReadable	= 0x80000000L
} ;
typedef PGPFlags		PGPNotationFlags;
...
enum /* PGPX509SigPropertyFlags_ */
{
	kPGPX509SigPropertyFlags_UsageTLSServer			= (1UL),
	kPGPX509SigPropertyFlags_UsageTLSClient			= (1UL << 1),
	kPGPX509SigPropertyFlags_UsageEmail				= (1UL << 2),
	kPGPX509SigPropertyFlags_UsageCA				= (1UL << 7)
} ;
typedef PGPFlags		PGPX509SigPropertyFlags;
...
PGPError 	PGPFindKeyByV3orV4KeyID( PGPKeyDBRef keyDBRef, const PGPKeyID * keyID,
					PGPKeyDBObjRef *keyRef);
...
PGPError	PGPAddTrustedCAFromFile( PGPContextRef context,
					PGPKeyDBRef destKeyDB );

PGPError	PGPSetTrustedCAFile(PGPContextRef context, PGPFileSpecRef caFile );
...
PGPError	PGPCountNotations( PGPKeyDBObjRef basekey, PGPUInt32 * numNotations);
					
PGPError 	PGPGetIndexedNotation( PGPKeyDBObjRef basekey, PGPUInt32 nth,
					PGPNotationFlags *flags, PGPByte *name, PGPUInt32 *nameLength,
					PGPByte *value, PGPUInt32 *valueLength );

PGPError 	PGPGetIndexedAllocatedNotation( PGPKeyDBObjRef basekey, PGPUInt32 nth,
					PGPNotationFlags *flags, PGPByte **name, PGPUInt32 *nameLength,
					PGPByte **value, PGPUInt32 *valueLength );
...
#define kPGPDefaultPassphraseCache    "default"
 
/* Deprecated, use PGPPurgeNamedPassphraseCache*() */
PGPError	PGPPurgePassphraseCache( PGPContextRef context);

PGPError	PGPPurgeNamedPassphraseCache( PGPContextRef context,
					const PGPChar8* cacheName );

/* Deprecated, use PGPCountCachedNamedPassphrases*() */
PGPError	PGPCountCachedPassphrases( PGPContextRef context,
					PGPUInt32 *pnLocal, PGPUInt32 *pnGlobal,
					PGPUInt32 *pnOtherLocal );

PGPError	PGPCountCachedNamedPassphrases( PGPContextRef context,
					PGPUInt32 *pnLocal, PGPUInt32 *pnGlobal,
					PGPUInt32 *pnOtherLocal, PGPUInt32 *pnPersistent, const PGPChar8* cacheName );
 
PGPError	PGPIsAuthenticationRequired(PGPKeyDBObjRef key,
  					const PGPChar8* cacheName, 
					PGPBoolean *isRequired );

PGPBoolean	PGPTokenAuthIsValid( PGPContextRef context, 
					PGPOptionListRef firstOption, ... );

PGPError	PGPRemoveCachedPassphrase( PGPKeyDBObjRef key, 
									   PGPOCachePassphraseFlags flags,
									   const PGPChar8* cacheName);
...
PGPError PGPGetKeyIDBytes( PGPKeyID const *keyID, PGPByte outKeyBytes[8], PGPSize *numKeyIDBytes );
...
PGPError	PGPDeleteKeyDBObjOnToken( PGPKeyDBObjRef key, 
...
PGPError	PGPSyncCSPKeys( PGPContextRef context, PGPKeyDBRef destKeyDB, 
						   PGPBoolean wrapperKeys, PGPBoolean *hadChanges);
PGPError	PGPCSPHasKeys(PGPContextRef context, PGPBoolean *hasKeys);
...
/* Deprecated, use  PGPDeleteKeyDBObjOnToken */
...
/* Given a srcKeySet, create new keydb with one bundle representing each member of srcKeySet.
 * Each member of srcKeySet is expected to be a private master key with X.509 certificate on it.
 */
PGPError	PGPCreateKeyBundle( PGPKeySetRef srcKeySet, PGPKeyDBRef *keydbout, 
					PGPOptionListRef firstOption, ... );

/*____________________________________________________________________________
    ocsp
____________________________________________________________________________*/
PGPError    PGPCreateOCSPRequest(PGPKeyDBObjRef		requestCertificate,
 					PGPKeyDBObjRef		issuerCertificate,
 					PGPByte				**byteRequest,
 					PGPSize				*byteRequestLen,
 					PGPKeyDBObjRef		signerKey,
 					PGPOptionListRef	firstOption,... );

PGPError	PGPVerifyOCSPResponse(PGPByte *byteResponse,
							PGPSize byteResponseLen,
 							PGPKeyDBObjRef		issuerCertificate,
							PGPKeyDBObjRef		requestCertificate,
 							PGPUInt *responseStatus,
							PGPUInt *certificateStatus);
PGPError PGPGetOCSPResponseURLsPrintable(PGPKeyDBObjRef certificate, 
							   PGPByte **addresses, 
							   PGPUInt32 *addressNumber);


PGPError PGPGetCAIURLsPrintable(PGPKeyDBObjRef certificate, 
							   PGPByte **addresses, 
							   PGPUInt32 *addressNumber);

PGPError	PGPCleanSignatures(PGPKeySetRef keys,
					PGPSignatureCleaning toClean );
