...
#include "pgpSDASymmetricCipher.h"
...
PGPError 	PGPsdaNewCBCContext( PGPSymmetricCipherContextRef ref,
...
PGPError 	PGPsdaFreeCBCContext( PGPCBCContextRef ref );

/*____________________________________________________________________________
	Make an exact copy, including current state.  Original is not changed.
____________________________________________________________________________*/

PGPError 	PGPsdaCopyCBCContext( PGPCBCContextRef ref, PGPCBCContextRef *outRef );
...
PGPError 	PGPsdaInitCBC( PGPCBCContextRef ref, const void *key,
...
PGPError 	PGPsdaCBCEncrypt( PGPCBCContextRef ref, const void *in,
					PGPSize bytesIn, void *out );
					
PGPError 	PGPsdaCBCDecrypt( PGPCBCContextRef ref, const void *in,
					PGPSize bytesIn, void *out );
...
PGPError 	PGPsdaCBCGetSymmetricCipher( PGPCBCContextRef ref,
