...
BJ_error_t NL_getUserId (nlchar * id_buf, int size)
{
...
/* ------------------------------------------------------------------------- */
long NL_GetFileModifiedTime(const nlchar *fileName, void *processToken)
{
  long ret = -1;
  struct stat s;
...
/* ------------------------------------------------------------------------- */
long NL_GetFileAccessTime(const nlchar *fileName, void *processToken)
{
  long ret = -1;
  struct stat s;
...
/* ------------------------------------------------------------------------- */
long NL_GetFileCreateTime(const nlchar *fileName, void *processToken)
{
  long ret = -1;
  return ret;
}
