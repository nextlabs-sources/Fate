========================================================================
    ACTIVE TEMPLATE LIBRARY : TagView Project Overview
========================================================================

AppWizard has created this TagView project for you to use as the starting point for
...
TagView.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (TagView.h)
        GUID definitions                                (TagView_i.c)
        A type library                                  (TagView.tlb)
        Marshaling code                                 (TagView_p.c and dlldata.c)

TagView.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in TagView.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named TagView.pch and a precompiled types file named StdAfx.obj.
...
TagViewps.vcproj
	...
	dlldata.c, TagView_i.c and TagView_p.c which are required
