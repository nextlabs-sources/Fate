...
# Print variables
print "Parameters:\n";
print "  ismTemplateFileName = $ismTemplateFileName\n";
print "  msiFileName32       = $msiFileName32\n";
print "  msiFileName64       = $msiFileName64\n";
print "  buildRootDir        = $buildRootDir\n";
print "  buildRootPath       = $buildRootPath\n";

# Modify installer script
my	$installDir = "$buildRootDir/install/pc";
...
&constructIsmFile($templateFile, $newIsmFile, $msiFileName32, $msiFileName64, $versionStr, $buildNum);
