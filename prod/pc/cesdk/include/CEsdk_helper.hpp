...
#ifndef __CESDK_HELPER_HPP__
#define __CESDK_HELPER_HPP__
...
namespace CESDK
{
  ...
  class Obligation
  {
    public:
       ...
       */
      bool GetObligationValue( const wchar_t* ob_key ,
	...
	return false;
       ...
       */
      bool IsObligationSet( const wchar_t* ob_key ) const
      {
	assert( ob_key != NULL );
	if( ob_key == NULL )
	{
  ...
  class Obligations
  {
    public:
       ...
       */
      static bool GetValue( const WCHAR* (*pfn_CEM_GetString)(CEString) ,
			    CEAttributes& obligations ,
			    const wchar_t* in_key ,
	...
	return false;
       ...
       */
      void Assign( const WCHAR* (*pfn_CEM_GetString)(CEString) ,
		   CEAttributes& obligations )
      {
	assert( pfn_CEM_GetString != NULL );
	...
	return obs.end();
       ...
       */
      bool IsObligationSet( const wchar_t* ob_name ) const
      {
	assert( ob_name != NULL );
	if( ob_name == NULL )
	{
